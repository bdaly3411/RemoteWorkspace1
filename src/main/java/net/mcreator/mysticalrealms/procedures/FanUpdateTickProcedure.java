...
public class FanUpdateTickProcedure extends MysticalrealmsModElements.ModElement {
	public FanUpdateTickProcedure(MysticalrealmsModElements instance) {
		super(instance, 118);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MysticalrealmsMod.LOGGER.warn("Failed to load dependency x for procedure FanUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				MysticalrealmsMod.LOGGER.warn("Failed to load dependency y for procedure FanUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MysticalrealmsMod.LOGGER.warn("Failed to load dependency z for procedure FanUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MysticalrealmsMod.LOGGER.warn("Failed to load dependency world for procedure FanUpdateTick!");
			return;
		}
			...
			if (((new Object() {
				...
				if ((((Entity) world.getEntitiesWithinAABB(LivingEntity.class,
					...
					((Entity) world.getEntitiesWithinAABB(LivingEntity.class,
							...
							}.compareDistOf(x, y, (z - 3))).findFirst().orElse(null)).setMotion(0, 0, (-0.2));
				}
				if ((((Entity) world.getEntitiesWithinAABB(ItemEntity.class,
						new AxisAlignedBB(x - (6 / 2d), y - (6 / 2d), (z - 3) - (6 / 2d), x + (6 / 2d), y + (6 / 2d), (z - 3) + (6 / 2d)), null)
						.stream().sorted(new Object() {
				...
				if ((((Entity) world.getEntitiesWithinAABB(LivingEntity.class,
					...
					((Entity) world.getEntitiesWithinAABB(LivingEntity.class,
							...
							}.compareDistOf((x - 3), y, z)).findFirst().orElse(null)).setMotion((-0.2), 0, 0);
				}
				if ((((Entity) world.getEntitiesWithinAABB(ItemEntity.class,
						new AxisAlignedBB((x - 3) - (6 / 2d), y - (6 / 2d), z - (6 / 2d), (x - 3) + (6 / 2d), y + (6 / 2d), z + (6 / 2d)), null)
						.stream().sorted(new Object() {
