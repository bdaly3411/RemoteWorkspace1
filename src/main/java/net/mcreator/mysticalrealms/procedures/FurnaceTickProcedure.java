...
import net.mcreator.mysticalrealms.item.RubyGemItem;
import net.mcreator.mysticalrealms.item.IronPlateItem;
...
public class FurnaceTickProcedure extends MysticalrealmsModElements.ModElement {
	public FurnaceTickProcedure(MysticalrealmsModElements instance) {
		super(instance, 143);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MysticalrealmsMod.LOGGER.warn("Failed to load dependency x for procedure FurnaceTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				MysticalrealmsMod.LOGGER.warn("Failed to load dependency y for procedure FurnaceTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MysticalrealmsMod.LOGGER.warn("Failed to load dependency z for procedure FurnaceTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MysticalrealmsMod.LOGGER.warn("Failed to load dependency world for procedure FurnaceTick!");
			return;
		}
		...
		if ((((new Object() {
			...
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(SapphireGemItem.block, (int) (1))
						.getItem()) && ((new Object() {
							public int getAmount(IWorld world, BlockPos pos, int sltid) {
								AtomicInteger _retval = new AtomicInteger(0);
								TileEntity _ent = world.getTileEntity(pos);
		...
		if (((new Object() {
			...
			if (((new Object() {
			...
			}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "timer")) >= 120)) {
				if (((new Object() {
					public double getValue(IWorld world, BlockPos pos, String tag) {
						TileEntity tileEntity = world.getTileEntity(pos);
						if (tileEntity != null)
				...
				}
				{
					...
					if (_ent != null) {
						final int _sltid = (int) (2);
						final ItemStack _setstack = new ItemStack(SapphireGemItem.block, (int) (1));
						_setstack.setCount((int) ((new Object() {
							public int getAmount(IWorld world, BlockPos pos, int sltid) {
								AtomicInteger _retval = new AtomicInteger(0);
								TileEntity _ent = world.getTileEntity(pos);
