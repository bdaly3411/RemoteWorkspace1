...
import net.mcreator.mysticalrealms.procedures.WireProcedure;
...
public class CableBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:cable")
	public static final Block block = null;
	@ObjectHolder("mysticalrealms:cable")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CableBlock(MysticalrealmsModElements instance) {
		super(instance, 165);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.CARPET).sound(SoundType.CLOTH).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0));
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				WireProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		private final EnergyStorage energyStorage = new EnergyStorage(50000, 300, 300, 0) {
			@Override
