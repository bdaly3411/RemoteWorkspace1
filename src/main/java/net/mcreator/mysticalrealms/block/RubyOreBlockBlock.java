...
public class RubyOreBlockBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:ruby_ore_block")
	public static final Block block = null;
	public RubyOreBlockBlock(MysticalrealmsModElements instance) {
		super(instance, 24);
	}
