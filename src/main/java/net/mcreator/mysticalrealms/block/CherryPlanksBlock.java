...
public class CherryPlanksBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:cherry_planks")
	public static final Block block = null;
	public CherryPlanksBlock(MysticalrealmsModElements instance) {
		super(instance, 125);
	}
