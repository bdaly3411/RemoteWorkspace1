...
public class TungstenOreBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:tungsten_ore")
	public static final Block block = null;
	public TungstenOreBlock(MysticalrealmsModElements instance) {
		super(instance, 169);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getGeneration().getFeatures(GenerationStage.Decoration.UNDERGROUND_ORES).add(() -> new OreFeature(OreFeatureConfig.CODEC) {
			...
			public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
				...
				if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("mysticalrealms:zimus")))
					dimensionCriteria = true;
		...
		}, block.getDefaultState(), 8)).range(70).square().func_242731_b(10));
	}
}
