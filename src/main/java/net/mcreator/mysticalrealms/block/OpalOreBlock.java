...
import net.mcreator.mysticalrealms.item.OpalGemItem;
...
public class OpalOreBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:opal_ore")
	public static final Block block = null;
	public OpalOreBlock(MysticalrealmsModElements instance) {
		super(instance, 89);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(OpalGemItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 1)).range(14).square().func_242731_b(2));
	}
}
