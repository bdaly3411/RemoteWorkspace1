...
public class BlackDiamondOreBlockBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:black_diamond_ore_block")
	public static final Block block = null;
	public BlackDiamondOreBlockBlock(MysticalrealmsModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_diamond_ore_block");
		}
