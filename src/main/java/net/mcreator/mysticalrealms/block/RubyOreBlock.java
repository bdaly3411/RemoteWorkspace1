...
public class RubyOreBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(MysticalrealmsModElements instance) {
		super(instance, 23);
