...
public class CherryFenceBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:cherry_fence")
	public static final Block block = null;
	public CherryFenceBlock(MysticalrealmsModElements instance) {
		super(instance, 129);
	}
