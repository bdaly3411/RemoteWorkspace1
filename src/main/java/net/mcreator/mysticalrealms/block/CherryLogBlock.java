...
public class CherryLogBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:cherry_log")
	public static final Block block = null;
	public CherryLogBlock(MysticalrealmsModElements instance) {
		super(instance, 124);
	}
