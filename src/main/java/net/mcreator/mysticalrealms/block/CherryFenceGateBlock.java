...
public class CherryFenceGateBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:cherry_fence_gate")
	public static final Block block = null;
	public CherryFenceGateBlock(MysticalrealmsModElements instance) {
		super(instance, 130);
	}
