...
import net.mcreator.mysticalrealms.procedures.Tier2SolarPanelUpdateTickProcedure;
...
public class Tier2SolarPanelBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:tier_2_solar_panel")
	public static final Block block = null;
	public Tier2SolarPanelBlock(MysticalrealmsModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tier_2_solar_panel");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				Tier2SolarPanelUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 25);
		}
	}
