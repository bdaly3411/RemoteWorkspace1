...
public class CrusherBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:crusher")
	public static final Block block = null;
	@ObjectHolder("mysticalrealms:crusher")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CrusherBlock(MysticalrealmsModElements instance) {
		super(instance, 188);
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 140);
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				GuiCrusherBindProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new CrusherTier1GUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(20000, 500, 500, 0) {
			@Override
