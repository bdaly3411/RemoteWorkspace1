...
public class OpalOreBlockBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:opal_ore_block")
	public static final Block block = null;
	public OpalOreBlockBlock(MysticalrealmsModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("opal_ore_block");
		}
