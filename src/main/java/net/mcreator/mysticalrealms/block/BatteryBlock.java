...
import net.mcreator.mysticalrealms.procedures.BatteryUpdateTickProcedure;
...
public class BatteryBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:battery")
	public static final Block block = null;
	@ObjectHolder("mysticalrealms:battery")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BatteryBlock(MysticalrealmsModElements instance) {
		super(instance, 162);
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		private final EnergyStorage energyStorage = new EnergyStorage(400000, 2000, 10000, 0) {
			@Override
