...
public class CherrySlabBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:cherry_slab")
	public static final Block block = null;
	public CherrySlabBlock(MysticalrealmsModElements instance) {
		super(instance, 128);
	}
