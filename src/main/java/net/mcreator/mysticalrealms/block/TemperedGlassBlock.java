...
public class TemperedGlassBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:tempered_glass")
	public static final Block block = null;
	public TemperedGlassBlock(MysticalrealmsModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tempered_glass");
		}
