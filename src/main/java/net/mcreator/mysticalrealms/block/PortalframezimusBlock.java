...
public class PortalframezimusBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:portalframezimus")
	public static final Block block = null;
	public PortalframezimusBlock(MysticalrealmsModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("portalframezimus");
		}
