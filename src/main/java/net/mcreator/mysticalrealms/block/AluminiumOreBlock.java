...
public class AluminiumOreBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:aluminium_ore")
	public static final Block block = null;
	public AluminiumOreBlock(MysticalrealmsModElements instance) {
		super(instance, 147);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 8)).range(100).square().func_242731_b(12));
	}
}
