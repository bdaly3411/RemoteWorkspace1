...
public class TopaztoolsOreBlockBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:topaztools_ore_block")
	public static final Block block = null;
	public TopaztoolsOreBlockBlock(MysticalrealmsModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("topaztools_ore_block");
		}
