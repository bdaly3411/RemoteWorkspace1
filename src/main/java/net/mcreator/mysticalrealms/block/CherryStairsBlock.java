...
public class CherryStairsBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:cherry_stairs")
	public static final Block block = null;
	public CherryStairsBlock(MysticalrealmsModElements instance) {
		super(instance, 127);
	}
