...
import net.mcreator.mysticalrealms.procedures.FanUpdateTickProcedure;
...
public class FanBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:fan")
	public static final Block block = null;
	@ObjectHolder("mysticalrealms:fan")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public FanBlock(MysticalrealmsModElements instance) {
		super(instance, 118);
