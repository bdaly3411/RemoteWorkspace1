...
import net.mcreator.mysticalrealms.procedures.InfuserUpdateTickProcedure;
import net.mcreator.mysticalrealms.procedures.InfuserOnBlockRightClickedProcedure;
...
public class InfuserBlock extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:infuser")
	public static final Block block = null;
	@ObjectHolder("mysticalrealms:infuser")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public InfuserBlock(MysticalrealmsModElements instance) {
		super(instance, 185);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				InfuserUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 200);
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				InfuserOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new PressGuiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(40000, 5000, 200, 0) {
			@Override
