...
public class GemBiome extends MysticalrealmsModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777063).setWaterColor(-3407821).setWaterFogColor(-3407821)
						.withSkyColor(-16777063).withFoliageColor(-3407872).withGrassColor(-3407872).build();
				...
				event.getRegistry().register(biome.setRegistryName("mysticalrealms:gem"));
			}
		}
	}
	@Override
