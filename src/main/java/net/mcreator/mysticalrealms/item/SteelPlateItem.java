...
public class SteelPlateItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:steel_plate")
	public static final Item block = null;
	public SteelPlateItem(MysticalrealmsModElements instance) {
		super(instance, 191);
	}
