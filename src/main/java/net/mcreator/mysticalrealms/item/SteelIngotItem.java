...
public class SteelIngotItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:steel_ingot")
	public static final Item block = null;
	public SteelIngotItem(MysticalrealmsModElements instance) {
		super(instance, 146);
	}
