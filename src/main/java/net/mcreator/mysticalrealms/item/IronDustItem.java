...
public class IronDustItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:iron_dust")
	public static final Item block = null;
	public IronDustItem(MysticalrealmsModElements instance) {
		super(instance, 194);
	}
