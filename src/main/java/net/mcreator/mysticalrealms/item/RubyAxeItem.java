...
public class RubyAxeItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:ruby_axe")
	public static final Item block = null;
	public RubyAxeItem(MysticalrealmsModElements instance) {
		super(instance, 29);
	}
