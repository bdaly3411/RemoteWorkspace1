...
public class IronGearItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:iron_gear")
	public static final Item block = null;
	public IronGearItem(MysticalrealmsModElements instance) {
		super(instance, 173);
	}
