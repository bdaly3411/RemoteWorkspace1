...
public class SteelDustItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:steel_dust")
	public static final Item block = null;
	public SteelDustItem(MysticalrealmsModElements instance) {
		super(instance, 196);
	}
