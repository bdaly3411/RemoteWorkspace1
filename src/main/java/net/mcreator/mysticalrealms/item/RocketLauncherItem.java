...
public class RocketLauncherItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:rocket_launcher")
	public static final Item block = null;
	@ObjectHolder("mysticalrealms:entitybulletrocket_launcher")
	public static final EntityType arrow = null;
	public RocketLauncherItem(MysticalrealmsModElements instance) {
		super(instance, 216);
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (RocketLauncherCanUseRangedItemProcedure.executeProcedure(ImmutableMap.of("itemstack", itemstack))) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 4f, 5, 5);
						...
						}
						{
							...
							RocketLauncherRangedItemUsedProcedure.executeProcedure($_dependencies);
						}
					}
				}
			}
