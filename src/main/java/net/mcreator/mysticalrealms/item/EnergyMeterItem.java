...
import net.mcreator.mysticalrealms.procedures.EnergyMeterRightClickedOnBlockProcedure;
...
public class EnergyMeterItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:energy_meter")
	public static final Item block = null;
	public EnergyMeterItem(MysticalrealmsModElements instance) {
		super(instance, 119);
	}
