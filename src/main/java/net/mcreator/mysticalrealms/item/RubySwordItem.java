...
public class RubySwordItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:ruby_sword")
	public static final Item block = null;
	public RubySwordItem(MysticalrealmsModElements instance) {
		super(instance, 30);
	}
