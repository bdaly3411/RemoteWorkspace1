...
public class OpalSwordItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:opal_sword")
	public static final Item block = null;
	public OpalSwordItem(MysticalrealmsModElements instance) {
		super(instance, 96);
	}
