...
public class RubyGemItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:ruby_gem")
	public static final Item block = null;
	public RubyGemItem(MysticalrealmsModElements instance) {
		super(instance, 22);
	}
