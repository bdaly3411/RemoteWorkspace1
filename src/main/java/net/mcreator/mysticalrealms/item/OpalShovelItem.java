...
public class OpalShovelItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:opal_shovel")
	public static final Item block = null;
	public OpalShovelItem(MysticalrealmsModElements instance) {
		super(instance, 97);
	}
