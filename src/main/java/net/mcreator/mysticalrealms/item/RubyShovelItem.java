...
public class RubyShovelItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:ruby_shovel")
	public static final Item block = null;
	public RubyShovelItem(MysticalrealmsModElements instance) {
		super(instance, 31);
	}
