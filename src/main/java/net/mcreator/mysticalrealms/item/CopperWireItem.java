...
public class CopperWireItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:copper_wire")
	public static final Item block = null;
	public CopperWireItem(MysticalrealmsModElements instance) {
		super(instance, 153);
	}
