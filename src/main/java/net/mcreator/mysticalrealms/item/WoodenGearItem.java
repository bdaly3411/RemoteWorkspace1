...
public class WoodenGearItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:wooden_gear")
	public static final Item block = null;
	public WoodenGearItem(MysticalrealmsModElements instance) {
		super(instance, 171);
	}
