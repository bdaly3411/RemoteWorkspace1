...
public class ZincIngotItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:zinc_ingot")
	public static final Item block = null;
	public ZincIngotItem(MysticalrealmsModElements instance) {
		super(instance, 166);
	}
