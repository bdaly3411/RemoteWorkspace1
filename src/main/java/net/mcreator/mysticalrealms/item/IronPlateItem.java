...
public class IronPlateItem extends MysticalrealmsModElements.ModElement {
	@ObjectHolder("mysticalrealms:iron_plate")
	public static final Item block = null;
	public IronPlateItem(MysticalrealmsModElements instance) {
		super(instance, 145);
	}
